--CREATE OR REPLACE FORCE VIEW OBIEE_ACCNT.EIS_AR_CUST_TRX_XXMGRC_V2  -- Commented by IT Convergence as Per R12.2.10 Upgrade
CREATE OR REPLACE FORCE VIEW EIS_AR_CUST_TRX_XXMGRC_V2  -- Added by IT Convergence as Per R12.2.10 Upgrade
(
   CUSTOMER_TRX_ID,
   TRX_NUMBER,
   TRX_DATE,
