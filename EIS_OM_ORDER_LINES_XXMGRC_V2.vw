CREATE OR REPLACE FORCE VIEW EIS_OM_ORDER_LINES_XXMGRC_V2
(
   ORDER_NUMBER,
   LINE_NUMBER,
   ORDERED_ITEM,
...
AS
   SELECT --In Addition to std. EIS table joins, this view has joins to following tables:
     ...
     FROM   hz_parties party,
            ...
            --apps.xxmgrc_om_rate_chg_audit_t omrc      /* MGRC customization */ -- Commented by IT Convergence as Per R12.2.10 Upgrade
