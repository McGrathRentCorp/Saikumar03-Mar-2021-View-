--CREATE OR REPLACE FORCE VIEW OBIEE_ACCNT.EIS_OM_ORDER_DETAILS_XXMGRC_V1  -- Commented by IT Convergence as Per R12.2.10 Upgrade
CREATE OR REPLACE FORCE VIEW EIS_OM_ORDER_DETAILS_XXMGRC_V1   -- Added by IT Convergence as Per R12.2.10 Upgrade
(
   ORG_ID,
   ORDER_TYPE_ID,
   ORDER_NUMBER,
     ...
     FROM   oe_order_headers oh,
           ...
           -- apps.oe_transaction_types_vl oltt,       -- Commented by IT Convergence as Per R12.2.10 Upgrade
            ...
            (SELECT       /*+ USE_MERGE(FND_FLEX_VSET_V,FND_FLEX_VALUES_VL) */
               ...
               FROM   
			/*    apps.invfv_inventory_organizations, -- Commented by IT Convergence as Per R12.2.10 Upgrade Start
            ...
            (SELECT                                      /*+ NO_CPU_COSTING */
               ...
               FROM  
			/*    bolinf.xxmgrc_om_billing_lines bill, -- Commented by IT Convergence as Per R12.2.10 Upgrade Start
                      apps.ra_terms term,
