CREATE OR REPLACE FORCE VIEW EIS_PO_DETAILS_XXMGRC_V1
(
   PO_HEADER_ID,
   PO_LAST_UPDATE_DATE,
   PO_LAST_UPDATED_BY,
...
AS
   SELECT --In Addition to std. EIS table joins, this view has joins to following tables:
            ...
            prod_type.product_type product_type       /* MGRC customization */
     FROM   po_headers poh,
            po_lines pol,
            po_line_locations poll,
            po_distributions pod,
           -- po_vendors pv, -- Commented by IT Convergence as Per R12.2.10 Upgrade
          --  po_vendor_sites pvs, -- Commented by IT Convergence as Per R12.2.10 Upgrade
		  ap_suppliers pv, -- Added by IT Convergence as Per R12.2.10 Upgrade
		  ap_supplier_sites_all pvs -- Added by IT Convergence as Per R12.2.10 Upgrade
		  AP_Supplier_Contacts pvc, -- Added by IT Convergence as Per R12.2.10 Upgrade
          --  po_vendor_contacts pvc, -- Commented by IT Convergence as Per R12.2.10 Upgrade
            po_line_types plt,
		   ...
		   ap_invoice_lines_all ap_inv,           /* MGRC customization */ -- Added by IT Convergence as Per R12.2.10 Upgrade
            ...
            (SELECT   a.inventory_item_id,
                      ...
                      b.segment1,
                      b.segment2,
                      c.description segment1_desc,
                      e.description product_type,
                      a.last_update_date mic_last_update_date,
                      b.last_update_date mc_last_update_date
              ...
              WHERE       a.category_id = b.category_id
                      AND a.category_set_id = 1100000041
                      AND c.flex_value_set_id = d.flex_value_set_id
                      AND d.parent_value_set_description =
                            'MGRC INV Item Major Category'
                      AND c.flex_value_meaning = b.segment1
                      AND e.flex_value_set_id = f.flex_value_set_id
                      AND f.parent_value_set_description =
                            'MGRC INV Item Major Category'
                      AND e.flex_value_meaning = b.segment2
                      AND e.parent_flex_value_low = b.segment1
                      AND f.flex_value = b.segment1) prod_type /* MGRC Customization */
    WHERE       poh.po_header_id = pol.po_header_id
            ...
            AND msi.inventory_item_id = prod_type.inventory_item_id(+)
