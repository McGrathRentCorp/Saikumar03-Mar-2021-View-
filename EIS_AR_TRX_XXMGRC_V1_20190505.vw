--CREATE OR REPLACE FORCE VIEW OBIEE_ACCNT.EIS_AR_TRX_XXMGRC_V1_20190505 -- Commented by IT Convergence as Per R12.2.10 Upgrade
CREATE OR REPLACE FORCE VIEW EIS_AR_TRX_XXMGRC_V1_20190505 -- Added by IT Convergence as Per R12.2.10 Upgrade
(
   TRX_NUMBER,
   TRX_DATE,
   TRX_COMMENTS,
     ...
     FROM   ra_customer_trx ct,
		...
		ra_cust_trx_types_all cttype,  /* MGRC customization */ -- Added by IT Convergence as Per R12.2.10 Upgrade
          ...
          --  ar.hz_customer_profiles rac_bill_prof,   -- Commented by IT Convergence as Per R12.2.10 Upgrade  
           ...
           -- ar.ar_payment_schedules_all ps,  -- Commented by IT Convergence as Per R12.2.10 Upgrade         
			ar_payment_schedules_all  /* MGRC customization */  -- Added by IT Convergence as Per R12.2.10 Upgrade
            (SELECT   *
               FROM   (SELECT   ROW_NUMBER ()
